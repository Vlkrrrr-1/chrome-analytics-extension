...
import IncognitoToggleSwitch from "../shared/IncognitoToggle";
import {
  exportSessionsCSV,
  exportSessionsJSON,
  deleteAllData,
...
import type { ProSectionProps } from "../types";
...
export default function ProSection({
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [scroll, events, pages, timeMs] = await Promise.all([
        getAverageScrollToday(),
        getActiveEvents(),
        getAllPages(),
        getTimeToday(),
    ...
    >
      ...
      >
        ...
        >
          ...
          <ToggleSwitch togglePause={togglePauseClick} isPaused={!isClick} />
        </Flex>
      </Box>
      {/*Active time */}
      <Box
        ...
        >
          ...
          <Box ml="2px">
            ...
            <Box
              ...
              padding="4px"
            >
              {isPaused ? "Not tracked" : "Tracked"} +{" "}
              {isIncognito ? "Anonymized" : "Normal mode"}
            </Box>
          </Box>
        </Flex>
      </Box>
